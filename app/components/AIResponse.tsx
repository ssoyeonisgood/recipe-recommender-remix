      ...
      <div>
        <DialogHeader>
          <DialogTitle className="flex flex-row items-center justify-center">
            ...
            Please try to upload a picture of your ingredients again.
      ...
      <div>
        <DialogHeader>
          ...
          <DialogDescription className="flex items-center justify-center text-center">
            We couldn’t find any recipes matching your selected ingredients and
            cooking time. <br />
            Try adjusting the cooking time or adding different ingredients to
            get better results.
          </DialogDescription>
        </DialogHeader>
      </div>
