    ...
    <div className="flex h-screen flex-col items-center justify-center bg-gradient-to-b from-white to-blue-200">
      ...
      <div className="xxs:mt-18 xs:mt-10 xs:mb-5 xs:p-1 xxl:p-24 flex h-full w-full flex-col items-center p-10 sm:mt-12 sm:p-1 xl:mt-0 xl:w-4/5 xl:p-20">
        <motion.h1
          ...
          className="xxs:text-xl xxs:mb-0 xxl:text-[180px] xxl:mb-20 mb-2 font-title text-3xl text-blue-900 sm:mb-2 sm:text-4xl md:mb-6 md:text-5xl xl:text-7xl"
        >
          Get Your Recipes
        </motion.h1>
        ...
        <motion.p
          ...
          className="xxs:text-sm xxs:mb-0 md:text-xxl xxl:text-6xl mb-4 text-center font-custom text-base sm:mb-0 sm:text-lg"
        >
